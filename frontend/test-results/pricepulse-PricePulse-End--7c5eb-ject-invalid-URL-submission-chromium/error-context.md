...
- Name: pricepulse.spec.ts >> PricePulse End-to-End Journey >> Should reject invalid URL submission
- Location: e2e\pricepulse.spec.ts:61:3
...
Locator: getByText(/Tracked Products/i)
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByText(/Tracked Products/i)

```

```yaml
- heading "Sign In to PricePulse" [level=2]
- paragraph: Enter your credentials to access your dashboard
- textbox "Email Address": default@user.com
